...
type LetStatement struct {
	Token token.Token // what node ast refering to
	Name  *Identifier
	Value Expression
}
...
// e.g. let x = add; where add identifier can produce value
...
// if <predicate> <consequence> else <alternative>;
